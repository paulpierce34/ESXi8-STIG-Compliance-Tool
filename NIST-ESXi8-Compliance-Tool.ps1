...
$LogOutputFile = "$env:USERPROFILE\Desktop\$Timestamp-esx-stig-script-logs.txt" ## Log output file (replace optional)
...
$Vuln258745 = 'V-258745',{(Get-VMHost | Get-VMHostService | Where {$_.Label -eq "NTP Daemon" -or $_.Label -eq "PTP Daemon"}).running},{},'true',''
